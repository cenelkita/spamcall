...
#CONTOH 8938373772
url = "https://id.jagreward.com/member/verify-mobile/8979838176"
...
def balik():
    ...
    if d == "y":
       subprocess.call("python call_.py",shell=True)
    elif d == "t":
         print ("\033[1;91mExit")
         os.system("exit")
bersih()
...
\033[1;97m
==================================================
Recoder  \033[1;91m:\033[1;96mCenelKITA\033[1;97m
Youtube \033[1;91m:\033[1;96mhttps://www.youtube.com/channel/UCHxt5WpcIsuzBrlHXAAKujg\033[1;97m
Whatsapp  \033[1;91m:\033[1;92m+682123444xxx\033[1;97m
==================================================
"""
print (banner)
jm = int(input("\033[1;97m[\033[1;96mmasukan jumlah spam\033[1;97m]:\033[1;93m"))
time.sleep(2)
subprocess.call("nano call_.py",shell=True)
